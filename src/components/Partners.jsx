    ...
    <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 lg:py-32">
      ...
      >
        <motion.div
          ...
          className="group flex items-center justify-center p-6 bg-gray-100/35 rounded-xl"
        >
          <img
            src={Logo1}
            alt="Partner 1"
      ...
      >
        <motion.div
          whileHover={{ scale: 1.05, y: -5 }}
          className="group w-full sm:w-1/3 flex items-center justify-center p-6 bg-gray-100/35 rounded-xl"
        >
          <img
            src={Logo4}
            alt="Partner 4"
